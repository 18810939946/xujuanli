...
{ 
	...
	s += '<tr align="center" class="birthdayHead"><td class="birthdayHead"><a href="#" onclick="refreshcalendar(yy, mm-1);return false" title="上一月"><<</a></td><td colspan="5" style="text-align: center" class="birthdayHead"><a href="#" onclick="showdiv(\'year\');_cancelBubble(event);return false" title="点击选择年份" id="year"></a>年<a id="month" title="点击选择月份" href="#" onclick="showdiv(\'month\');_cancelBubble(event);return false"></a>月</td><td class="birthdayHead"><A href="#" onclick="refreshcalendar(yy, mm+1);return false" title="下一月">>></A></td></tr>';
...
{ 
	...
	$('calendar').style.left = (p['x'] + 1)+'px';
	$('calendar').style.top = (p['y'] + 29)+'px';
	_cancelBubble(event); 
